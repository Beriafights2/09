...
//   
var des = "<color=Blue>РЕЖИМ ОТ 尺尺口乇卂工</a>";   
...
Players.Get.build.BuildRangeEnable.Value = true;     var 100 =                            AreaPlayer100Service.Get("100");      100.Tags = ["100"];                  100.Enable = true;                    100.OnEnter.OnEnter.Add(function(player,area){                            ++player.Properties.Kills.Value;     player.Properties.Scores.Value += 100;
